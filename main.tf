...
module "distributed_topo" {
  #For Basic only master_img_path and worker_img_path is required.  #source = "modules/basic_topology/"  #worker_img_path ="paste_worker_image_path"   #master_img_path ="paste_master_image_path"
